...
def configure_permitted_parameters
   devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:name_driver ,:address_driver , :telephone_driver,:placa_driver , :email, :password, :password_confirmation, :remember_me,:picture) }
